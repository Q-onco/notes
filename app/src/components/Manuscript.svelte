    ...
    <div class="editor-col">
        ...
        <div class="editor-top-bar">
          ...
          <div class="editor-toolbar">
            ...
            <button class="btn btn-sm btn-enzo" onclick={runEnzo} disabled={enzoLoading}>
              ...
              {enzoLoading ? 'Thinking…' : 'Ask Enzo'}{#if !enzoLoading}<span class="model-pill">[70B]</span>{/if}
            </button>
            {#if enzoOpen}
      ...
      <div class="legend-panel">
        ...
        <button class="btn btn-primary btn-sm" onclick={runLegendGen} disabled={legendStreaming || !legendFigDesc.trim()}>
          {#if legendStreaming}<span class="ms-spinner-xs"></span> Generating…{:else}Generate Legend<span class="model-pill">[70B]</span>{/if}
        </button>
