<script lang="ts">
  ...
  const NEW_FEATURES = [
    { color: 'bl', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', title: 'Bibliography: Full Reference Manager', desc: 'A complete Zotero/Mendeley replacement built into Q-onco. Import references by DOI (CrossRef + Unpaywall OA detection), PubMed ID, arXiv ID, BibTeX/RIS paste, or manual entry. Duplicate detection, nested collections, tag cloud, star ratings, and read-status tracking. Four citation styles: Vancouver (default), APA, Nature, Chicago. One-click copy and BibTeX/RIS export. Includes a curated library of 80 landmark papers across 10 categories — Cancer Immunology, scRNA-seq, CRISPR, Bioinformatics, Clinical Trials, Precision Oncology, TME, Drug Resistance, Translational/Regulatory, and Epigenomics — each importable to your personal library.' },
