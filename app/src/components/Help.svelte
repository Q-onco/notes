<script lang="ts">
  ...
  const ALL_MODULES = [
    ...
    { id: 'presentations', label: 'Presentations',   color: 'yw',   icon: 'M2 3h20v14H2zM8 21h8M12 17v4', desc: 'Slide editor with 4 Enzo generation modes (Standard, Journal Club, Lab Meeting, Grant Narrative), multi-source picker (Notes, Papers, Files — PDFs/CSVs, Pipeline runs), JSON-schema structured decks, context-aware slide improve, 21 templates with Enzo-fill, source sidebar, citation strip, thumbnail strip, drag-to-reorder, present mode with timer, and reveal.js HTML export.' },
